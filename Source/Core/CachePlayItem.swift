...
//            debugPrint("init: startDataRequest")
...
//            debugPrint("init: processPendingRequests")
...
//            debugPrint("init: fillInContentInformationRequest")
...
//            debugPrint("init: haveEnoughDataToFulfillRequest")
    ...
    public init(url: URL, customFileExtension: String?) {
        ...
        asset.resourceLoader.setDelegate(resourceLoaderDelegate, queue: Constants.worker)
